...
import {Home, Category,Settings, Pets, ShoppingCart, PowerSettingsNew,} from '@material-ui/icons';
 ...
 const Dashboard=({setUserLogout})=> {
  ...
  return (
    <div className={classes.root}>
      <CssBaseline />
      <AppBar position="fixed" style={{backgroundColor:'#8EC957'}} className={clsx(classes.appBar, {[classes.appBarShift]: open,})} >
        <Toolbar>
          ...
          {/* <img src={IMAGES.logo} style={{height:50}} alt="" /> */}
        </Toolbar>
      </AppBar>
      <Drawer
        variant="permanent"
...
export default connect(null,{setUserLogout})(Dashboard);
